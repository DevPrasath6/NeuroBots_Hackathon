...
// Enable CORS for allow-listed origins only (reflecting all origins with
// credentials:true would defeat the purpose of cookie-based CSRF protection)
...
app.use(
  cors({
    origin(origin, callback) {
      // Allow non-browser tools (no Origin header) and any explicitly allow-listed origin
...
app.use('/api/v2/spectrometer', spectrometerRouter);
